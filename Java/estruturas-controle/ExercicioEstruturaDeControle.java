...
//		// e verifique se ele está entre 0 e 10 e é par;
		...
		String palavraimprime = entrada.nextLine();
		

		char letras[] = palavraimprime.toCharArray();
		...
		for(int x = 0; x <= 10; x++) {
			...
			System.out.print("\nDigite um número: ");
			double contarnumero = entrada.nextDouble();
			
			
			if (contarnumero >= relativo) {
				relativo = contarnumero;
			}
				System.out.printf("\nO maior número foi: %.2f ", relativo);	
